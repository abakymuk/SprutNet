# Быстрое исправление popular_routes
...
-- Проверить индексы
SELECT indexname FROM pg_indexes WHERE tablename = 'popular_routes';
```

## Готово!

После выполнения этого SQL кэширование должно работать корректно.
